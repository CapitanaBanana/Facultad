...
import ar.edu.info.unlp.ejercicioDemo.Archivo;
import ar.edu.info.unlp.ejercicioDemo.Directorio;
import ar.edu.info.unlp.ejercicioDemo.FileSystem;
...
class DirectorioTest {
	...
	void testArchivoMasNuevo() {
		assertEquals(archA123.getCreacion(), dirA1.archivoMasNuevo().getCreacion());
	...
	void testListado() {
		...
		contenido.stream().forEach(componente -> union.append(componente.listadoDeContenido()));
