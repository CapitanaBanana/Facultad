...
public class PruebaNafta {
	...
	public static void main(String[] args) {
		...
		Nafta parcial = new Nafta(ciudades);
		
    ListaGenerica<String> lis = parcial.caminoConMenorCargaDeCombustible("Buenos Aires", "Asuncion", 6);
		lis.comenzar();
		while(!lis.fin()) {
